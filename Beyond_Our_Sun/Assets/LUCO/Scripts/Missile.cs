...
public class Missile : MonoBehaviour
{
    ...
    {
        if (other.gameObject.layer == 9)    //si le GameObject avec lequel le missile entre en collision est sur le layer 9
        {
            //collision.gameObject.GetComponent<Health>(); //infliger des dégats par la suite
